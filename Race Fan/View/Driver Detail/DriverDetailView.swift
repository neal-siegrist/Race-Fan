...
class DriverDetailView: UIView {
    ...
    let dateOfBirthStack: UIStackView = {
    ...
    private func setupSubviews() {
        ...
        self.addSubview(constructorLabel)
        self.addSubview(dividerLineView)
        
        dateOfBirthStack.addArrangedSubview(dateOfBirthLabel)
        dateOfBirthStack.addArrangedSubview(dateOfBirth)
        self.addSubview(dateOfBirthStack)
    ...
    private func setupTeamColorView() {
        NSLayoutConstraint.activate([
            ...
            teamColor.bottomAnchor.constraint(equalTo: constructorLabel.bottomAnchor),
    ...
    private func setupConstructorLabel() {
        NSLayoutConstraint.activate([
            constructorLabel.topAnchor.constraint(equalTo: nameLabel.bottomAnchor, constant: 5),
            constructorLabel.leftAnchor.constraint(equalTo: nameLabel.leftAnchor),
            constructorLabel.rightAnchor.constraint(equalTo: nameLabel.rightAnchor)
        ])
    }
    
    private func setupDividerLine() {
        NSLayoutConstraint.activate([
            dividerLineView.topAnchor.constraint(equalTo: constructorLabel.bottomAnchor, constant: 20),
    ...
    private func setupDateOfBirth() {
        NSLayoutConstraint.activate([
            dateOfBirthStack.topAnchor.constraint(equalTo: dividerLineView.bottomAnchor, constant: 15),
            dateOfBirthStack.leftAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leftAnchor, constant: Self.HORIZONTAL_PADDING),
            dateOfBirthStack.rightAnchor.constraint(equalTo: self.safeAreaLayoutGuide.rightAnchor, constant: -Self.HORIZONTAL_PADDING)
        ])
    }
    
    private func setupNationality() {
        NSLayoutConstraint.activate([
            nationalityStack.topAnchor.constraint(equalTo: dateOfBirthStack.bottomAnchor, constant: 10),
